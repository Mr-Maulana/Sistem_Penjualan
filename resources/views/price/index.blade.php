                ...
                <tr class="hover:bg-slate-50/80 transition-colors group">
                    <td class="px-6 py-4">
                        ...
                        <div class="flex flex-wrap items-center gap-1.5 mt-1.5">
                            <span class="inline-flex items-center px-1.5 py-0.5 rounded bg-slate-50 text-slate-400 text-[9px] font-mono uppercase tracking-tighter border border-slate-100">
                                {{ $p->product?->code ?? '' }}
                            </span>
                            <span class="inline-flex items-center gap-1 px-1.5 py-0.5 rounded bg-blue-50 text-blue-600 text-[9px] font-bold uppercase tracking-wide border border-blue-100/60 shadow-sm">
                                <i data-lucide="truck" style="width:10px;height:10px;" class="text-blue-400"></i>
                                {{ $p->product?->supplier?->name ?? 'Tidak Ada Supplier' }}
                            </span>
                        </div>
                    </td>
                    <td class="px-6 py-4">
